		...
		>
			{data
				...
				.map((item, index) => {
					...
					const labelX =
						centerX + labelRadius * Math.cos(midpointAngle);
					const labelY =
						centerY + labelRadius * Math.sin(midpointAngle);

					const arcXEnd =
						centerX + labelRadius * Math.cos(midpointAngle) * 0.9;
					const arcYEnd =
						centerY + labelRadius * Math.sin(midpointAngle) * 0.9;
					...
					const lightness =
						maxLightness -
						normalizedValue * (maxLightness - minLightness);
